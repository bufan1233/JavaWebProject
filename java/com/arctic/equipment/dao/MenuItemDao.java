...
public class MenuItemDao {
    ...
    public java.util.List<com.arctic.equipment.entity.MenuItem>
    searchByName(String keyword) throws SQLException {

        java.util.List<com.arctic.equipment.entity.MenuItem> list =
        ...
        try (
            ...
            try (
                ...
                while (rs.next()) {
                    ...
                    com.arctic.equipment.entity.MenuItem item =
                            new com.arctic.equipment.entity.MenuItem();
    ...
    public void addMenuItem(String name, java.math.BigDecimal price, int stock) throws SQLException {
        Connection conn = DBUtil.getConnection();
        String sql = "INSERT INTO menu_item (name, price, stock, category) VALUES (?, ?, ?, '主食')";
        try (PreparedStatement pstmt = conn.prepareStatement(sql)) {
            pstmt.setString(1, name);
            pstmt.setBigDecimal(2, price);
